...
import '../../ui/screens/main/main_screen_view_model.dart' as _i49;
import '../../ui/screens/main/tabs/home/home_view_model.dart' as _i48;
...
import '../../ui/screens/main/tabs/profile/change_password/change_pass_view_model.dart'
    as _i21;
import '../../ui/screens/main/tabs/profile/profile_view_model.dart' as _i52;
...
import '../use_cases/create_comment_and_rate_use_case.dart' as _i42;
import '../use_cases/get_places_use_case.dart' as _i43;
import '../use_cases/get_profile_use_case.dart' as _i44;
import '../use_cases/get_specific_place_use_case.dart' as _i45;
import '../use_cases/get_specific_user_use_case.dart' as _i46;
import '../use_cases/get_transactions_use_case.dart' as _i22;
import '../use_cases/get_users_use_case.dart' as _i47;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i41.CashPaymentViewModel>(
        () => _i41.CashPaymentViewModel(gh<_i29.PaymentCashUseCase>()));
    gh.factory<_i42.CreateCommentAndRateUseCase>(
        () => _i42.CreateCommentAndRateUseCase(gh<_i25.HomeRepo>()));
    gh.factory<_i43.GetPlacesUseCase>(
        () => _i43.GetPlacesUseCase(gh<_i25.HomeRepo>()));
    gh.factory<_i44.GetProfileUseCase>(
        () => _i44.GetProfileUseCase(gh<_i32.ProfileRepo>()));
    gh.factory<_i45.GetSpecificPlacesUseCase>(
        () => _i45.GetSpecificPlacesUseCase(gh<_i25.HomeRepo>()));
    gh.factory<_i46.GetSpecificUserUseCase>(
        () => _i46.GetSpecificUserUseCase(gh<_i32.ProfileRepo>()));
    gh.factory<_i47.GetUsersUseCase>(
        () => _i47.GetUsersUseCase(gh<_i32.ProfileRepo>()));
    gh.factory<_i48.HomeViewModel>(
        () => _i48.HomeViewModel(gh<_i43.GetPlacesUseCase>()));
    gh.factory<_i49.MainViewModel>(() => _i49.MainViewModel(
          gh<_i11.SharedPreferenceGlobal>(),
          gh<_i9.PaymentUseCase>(),
          gh<_i43.GetPlacesUseCase>(),
        ));
    gh.factory<_i50.PlaceDetailsViewModel>(() => _i50.PlaceDetailsViewModel(
          gh<_i45.GetSpecificPlacesUseCase>(),
          gh<_i42.CreateCommentAndRateUseCase>(),
        ));
    gh.factory<_i51.ProfileFromQRViewModel>(() => _i51.ProfileFromQRViewModel(
          gh<_i12.SharedPrefsUtils>(),
          gh<_i43.GetPlacesUseCase>(),
          gh<_i47.GetUsersUseCase>(),
          gh<_i46.GetSpecificUserUseCase>(),
        ));
    gh.factory<_i52.ProfileViewModel>(() => _i52.ProfileViewModel(
          gh<_i12.SharedPrefsUtils>(),
          gh<_i44.GetProfileUseCase>(),
          gh<_i43.GetPlacesUseCase>(),
          gh<_i47.GetUsersUseCase>(),
        ));
    gh.factory<_i53.TransactionsViewModel>(() => _i53.TransactionsViewModel(
          gh<_i22.GetTransactionsUseCase>(),
          gh<_i44.GetProfileUseCase>(),
        ));
    gh.factory<_i54.UpdatePictureViewModel>(() => _i54.UpdatePictureViewModel(
          gh<_i44.GetProfileUseCase>(),
