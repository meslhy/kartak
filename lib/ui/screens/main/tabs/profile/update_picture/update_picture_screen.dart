      ...
      child: Scaffold(
        ...
        body: BlocBuilder(
          ...
          builder: (context, state) {
            print(state);
            if(state is BaseRequestSuccessState<AuthData>){
              return Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  const Spacer(),
                  CachedNetworkImage(
                    imageUrl:state.data?.cloudImage?.url??"https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png",
